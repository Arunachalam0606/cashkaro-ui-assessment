...
export interface CouponCardCopiedMobileSvgProps extends SVGProps<SVGSVGElement> {
  timer?: string
}

export const CouponCardCopiedMobileSvg = (
  props: CouponCardCopiedMobileSvgProps
) => {
  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_mobile_copied)">
        ...
        <path
          d="M10 78.6536C10 80.8053 11.7694 82.4966 13.7311 83.3808C17.2061 84.9471 19.625 88.4406 19.625 92.5C19.625 96.5594 17.2061 100.052 13.7311 101.618C11.7693 102.502 10 104.194 10 106.345V112H54V68H10V78.6536Z"
          fill="url(#paint2_linear_mobile_copied)"
        />
        <path
          d="M10 78.6536C10 80.8053 11.7694 82.4966 13.7311 83.3808C17.2061 84.9471 19.625 88.4406 19.625 92.5C19.625 96.5594 17.2061 100.052 13.7311 101.618C11.7693 102.502 10 104.194 10 106.345V112H54V68H10V78.6536Z"
          fill="url(#paint3_linear_mobile_copied)"
        />
        <path
          d="M54 112H10V162C10 168.627 15.3726 174 22 174H54V112Z"
          fill="url(#paint4_linear_mobile_copied)"
        />
        <path
          ...
          fill="white"
        />
        <g clipPath="url(#clip0_mobile_copied)">
          <g filter="url(#filter1_d_mobile_copied)">
            <path
        ...
        <path
          ...
          fill="#580202"
        />
        <g filter="url(#filter2_d_mobile_copied)">
          <path
          ...
          <path
            d="M67 4L168.5 4H168.371C165.122 4 162.196 5.96434 160.966 8.97094L157.869 16.5436C156.024 21.0535 151.635 24 146.762 24H87.6229C82.5592 24 78.0404 20.8214 76.329 16.0555L73.6898 8.7058C72.6761 5.88283 69.9995 4 67 4Z"
            fill="url(#paint5_linear_mobile_copied)"
          />
        </g>
        <g clipPath="url(#clip1_mobile_copied)">
          <path
        ...
        <mask id="path-13-inside-1_mobile_copied" fill="white">
        ...
        <path
          ...
          fill="url(#paint6_linear_mobile_copied)"
          mask="url(#path-13-inside-1_mobile_copied)"
        />
        <path
          ...
          fill="white"
        />
        <mask id="path-16-inside-2_mobile_copied" fill="white">
        ...
        <path
          ...
          fill="url(#paint7_linear_mobile_copied)"
          mask="url(#path-16-inside-2_mobile_copied)"
        />
        <mask id="path-18-inside-3_mobile_copied" fill="white">
        ...
        <path
          ...
          fill="url(#paint8_linear_mobile_copied)"
          mask="url(#path-18-inside-3_mobile_copied)"
        />
        <mask id="path-20-inside-4_mobile_copied" fill="white">
        ...
        <path
          ...
          fill="#C1C1C1"
          mask="url(#path-20-inside-4_mobile_copied)"
        />
      </g>
      <defs>
        <filter
          id="filter0_d_mobile_copied"
          x="0"
          y="0"
          width="348"
          height="190"
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_mobile_copied"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_mobile_copied"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_d_mobile_copied"
          x="45"
          y="-67"
          width="18"
          height="314"
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.356863 0 0 0 0 0.733333 0 0 0 0 0.443137 0 0 0 1 0"
          />
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
        ...
        <linearGradient
          id="paint0_linear_mobile_copied"
          x1="54"
          y1="37"
          x2="10"
          y2="37"
        ...
        <linearGradient
          id="paint1_linear_mobile_copied"
          x1="54"
          y1="37"
          x2="10"
          y2="37"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#5CBC71" />
          <stop offset="1" stopColor="#1D985C" />
        </linearGradient>
        <linearGradient
          id="paint2_linear_mobile_copied"
          x1="54"
          y1="90"
          x2="10"
          y2="90"
        ...
        <linearGradient
          id="paint3_linear_mobile_copied"
          x1="10"
          y1="90"
          x2="54"
          y2="90"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#1D985C" />
          <stop offset="1" stopColor="#5CBC71" />
        </linearGradient>
        <linearGradient
          id="paint4_linear_mobile_copied"
          x1="54"
          y1="143"
          x2="10"
          y2="143"
        ...
        <linearGradient
          id="paint5_linear_mobile_copied"
          x1="67"
          y1="14"
          x2="199.5"
          y2="14"
        ...
        <linearGradient
          id="paint6_linear_mobile_copied"
          x1="346"
          y1="72.0185"
          x2="321.111"
          y2="8.09824"
        ...
        <linearGradient
          id="paint7_linear_mobile_copied"
          x1="346"
          y1="107.981"
          x2="321.111"
          y2="171.902"
        ...
        <linearGradient
          id="paint8_linear_mobile_copied"
          x1="338"
          y1="33"
          x2="10"
          y2="33"
        ...
        <clipPath id="clip0_mobile_copied">
          <rect
            width="9"
            height="168"
            fill="white"
        ...
        <clipPath id="clip1_mobile_copied">
          <rect
            width="10"
            height="10"
            fill="white"
...
export default CouponCardCopiedMobileSvg
